...
app.post("/Huser", async (req, res) => {
  ...
  try {
    ...
    sendEmail(
      email,
      `Welcome to guest`,
      `Subject: Welcome to guest - Your New Home Away from Home
Dear ${name},
Welcome to guest! We are thrilled to have you join our community of travelers and hotel enthusiasts. Your registration is the first step towards unlocking a world of delightful stays and memorable experiences.
At guest, we understand that every journey is unique, and we are committed to ensuring that your stay with us is nothing short of exceptional. Whether you're traveling for business or leisure, our goal is to provide you with a comfortable and welcoming environment that feels like home.
...
We want your experience with guest to be seamless from start to finish. If you have any questions or need assistance, please do not hesitate to contact us at [email protected]
Once again, welcome to guest. We look forward to being a part of your travel adventures and helping you create unforgettable memories.
Best regards,
GuestHarbor Team`
    );
...
You are receiving this email because you have requested to reset your password for your guest account. To reset your password, please click on the link below:
