...
function Deal() {
  ...
  useEffect(() => {
    axios.get("https://my-hotel-mauve.vercel.app/deal").then((res) => {
      setDeals(res.data);
    });
  }, []);
  ...
  function dealSubmit(e) {
    ...
    if (editingDealId) {
      axios
        .put(`https://my-hotel-mauve.vercel.app/deal/${editingDealId}`, {
          name,
          price,
          day,
          bed,
      ...
      axios
        .post("https://my-hotel-mauve.vercel.app/deal", formData, {
          headers: {
  ...
  function deleteDeal(id) {
    axios
      .delete(`https://my-hotel-mauve.vercel.app/deal/${id}`)
      .then(() => {
